...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(cn.djzhao.circleindicatorview.R.layout.activity_main);
    ...
    private void initView() {
        // 初始化ViewPager 相关
        mViewPager = (ViewPager) findViewById(cn.djzhao.circleindicatorview.R.id.viewpager);
        mPagerAdapter = new ViewPagerAdapter();
        mViewPager.setAdapter(mPagerAdapter);

        mIndicatorView = (CircleIndicatorView) findViewById(cn.djzhao.circleindicatorview.R.id.indicator_view);
        // 关联ViewPager
